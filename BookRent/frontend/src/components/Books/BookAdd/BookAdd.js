...
const BookAdd = (props) => {
    ...
    const handleChange = (e) => { //e=event (onChange event)
        updateFormData({
            ...formData,
    ...
    const onFormSubmit = (e) => {
        e.preventDefault(); //ne prakjaj podatoci vednas, nie odlucuvame sto ke se prati
        ...
        history.push("/books");//ne vrakja na stranata /books
